...
<body class="vertical-layout" data-color="bg-gradient-x-purple-blue">
    <div class="app-content content">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body text-center">
                                <h4 class="mb-2"><strong>OFFICIAL BINS [RATE LIMT BYPASS CHECKER] </strong></h4>
                                <h4 class="mb-2"><strong>BY OFFICIAL BINS</strong></h4>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-2">
                            <div class="card-body">
                                ...
                                <h5>HIT :<span class="badge badge-success float-right charge">0</span></h5>
                                <hr>
        ...
        <footer>
            <p>Modified By <a href="https://t.me/OFFICIAL_BINS">@OFFICIAL_BINS</a></p>
        </footer>
        <script>
            $(document).ready(function() {
                ...
                function RedirectUrl() {
                    window.location.href = "https://t.me/OFFICIAL_BINS";
                }
